...
def parse_args():
    ...
    parser.add_argument("--output_json",
                        type=str,
                        default='lujiazui_16.json')
    parser.add_argument("--input_xml",
                        type=str,
                        default='2023浦江实验室-陆家嘴/中心大厦16点绕飞+环球+金茂 - pos.xml')
...
results = {}
# high_tower=[0,1,2,3,16,17,18,19,20,21]
high_tower=[0,1,2,3,4,5]

for g_id in tqdm(range(29)):
    # if g_id not in high_tower:
    #     continue
...
# with open('high_tower_white.json', 'w') as f:
#     json.dump(results, f, indent=4)

# with open('china_museum.json', 'w') as f:
    # json.dump(results, f, indent=4)
